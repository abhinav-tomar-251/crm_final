...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      botmartz_app_email: email,
      botmartz_app_company_email: email,
      botmartz_app_timezone: timezone,
      botmartz_app_country: country,
      botmartz_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully botmartz App Setup',
  });
};
